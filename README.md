...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-sjaoplg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-sjaoplg.containers.anotherwebservice.com/
...
```
git clone git@github.com:pupupupu111/container-sjaoplg.git
cd container-sjaoplg
```
...
```
docker attach container-sjaoplg
```
